...
- [7.1 前端在架构中的角色](7.1_前端在架构中的角色.md) —— 后端模板渲染 vs 前后端分离：职责如何切、URL 与数据如何分工、MeetingToText 如何落地
- [7.2 框架三驾马车](7.2_框架三驾马车.md) —— React / Vue / Angular 设计哲学客观对比：声明式、响应式与企业级约束的 trade-off
- [7.3 为何选择 Vue 3 + Vite](7.3_为何选择Vue3_Vite.md) —— 组合式 API、Proxy 响应式与构建速度：本课程前端栈的选型依据
- [7.4 前端工程化基石](7.4_前端工程化基石.md) —— Node.js、npm/pnpm、ES Module：前端如何拥有自己的“运行时 + 包管理 + 模块系统”
...
> **跨平台约定**：本章所有涉及路径与环境激活的命令均标注 Windows / macOS / Linux 差异，详见各小节对照表；正文跨章引用一律使用相对链接，如 [第1章 开发者的元技能](../../part1_软件工程筑基/chapter01_开发者的元技能/index.md) 与 [第3章 后端开发到底是什么](../../part2_后端开发全景与核心基石/chapter03_后端开发到底是什么/index.md)。

文件 `book/part3_前端协作与现代前端基础/chapter07_前端开发概况与工程化演进/demo_index.py`（验证本章环境与前后端协作概念可用）：

```{code-cell} ipython3
# 文件 book/part3_前端协作与现代前端基础/chapter07_前端开发概况与工程化演进/demo_index.py
