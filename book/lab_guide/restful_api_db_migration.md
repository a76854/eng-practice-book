...
本实验对应理论 [第4章 HTTP 与 RESTful 架构](../../backend_development/http_restful/index.md) 与 [第5章 数据持久化：从 SQL 到 ORM](../../backend_development/persistence_sql_orm/index.md)。建议先通读第4章 4.1 至 4.4 节的 HTTP 语义与 FastAPI 路由，再通读第5章 5.3 至 5.4 节的数据库访问三境界与迁移思想，再动手。你会在本实验中用 FastAPI 实现会议记录的增删改查接口，并用版本化思想管理表结构演进。
...
1. 阅读 [第4章 4.1 HTTP 与 RESTful](../../backend_development/http_restful/http_and_restful.md) 至 [4.3 统一响应与契约](../../backend_development/http_restful/error_and_contract.md)，留意方法语义、状态码与统一响应的协作价值。
2. 阅读 [第5章 5.3 SQL](../../backend_development/persistence_sql_orm/accessing_database.md) 与 [5.4 ORM](../../backend_development/persistence_sql_orm/orm.md)，理解参数化查询与 ORM 配合迁移的必要性。
