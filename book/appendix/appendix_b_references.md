...
本附录按全书五篇结构与 11 章知识点组织延伸阅读，分为“核心必读”（课程配套，1–2 本/章）与“进阶选读”（学有余力）。标注 `免费` 的资源可直接在线获取。选书原则：与本书“以 MeetingToText 一条贯穿案例串起工程全链路”的定位互补——本书重可复现的最小闭环，参考书补单点的深度与“为什么”。
...
3. **本书的差异化**：上述书均为单点深入，而本书用 MeetingToText 一条案例把 Part1→Part4 串成可复现的闭环——这是现有教材中稀缺的定位，可在前言中明确强调。
