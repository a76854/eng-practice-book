...
- [CI/CD 流水线](cicd_pipeline.md) —— GitHub Actions 的工作流、作业与步骤模型与本地可验证的门禁链路
...
> **环境约定**：本书面向 Linux，本章命令均面向 Linux，路径与环境激活统一使用 `source .venv/bin/activate` 与 `/` 分隔符；正文跨章引用一律使用相对链接，如 [第1章 开发者的元技能](../../software_engineering/dev_meta_skills/index.md) 与 [第10章 健壮性与安全底线](../robustness_security/index.md)。
