...
本实验对应理论 [第7章 前端开发概况与工程化演进](../../part3_前端协作与现代前端基础/chapter07_前端开发概况与工程化演进/index.md) 与 [第8章 Vue3 核心机制与状态设计](../../part3_前端协作与现代前端基础/chapter08_Vue3核心机制与状态设计/index.md)。建议先通读第7章 7.2 至 7.4 节的框架选型与工程基石，再通读第8章 8.1 至 8.4 节的响应式、组件化、路由与 Pinia，最后参考 `book/samples/vue-min/` 的最小实现，再动手。你会在本实验中用 Vue3 + Pinia + Vue Router 完成会议记录管理面板、登录态保持与路由拦截的闭环。
...
1. 阅读 [第7章 7.2 框架三驾马车](../../part3_前端协作与现代前端基础/chapter07_前端开发概况与工程化演进/7.2_框架三驾马车.md) 至 [7.4 前端工程化基石](../../part3_前端协作与现代前端基础/chapter07_前端开发概况与工程化演进/7.4_前端工程化基石.md)，理解 Vue3 在本课程中的选型理由与 `package.json` 的工程化作用。
2. 阅读 [第8章 8.1 响应式原理](../../part3_前端协作与现代前端基础/chapter08_Vue3核心机制与状态设计/8.1_响应式原理.md) 至 [8.4 跨组件状态管理 Pinia](../../part3_前端协作与现代前端基础/chapter08_Vue3核心机制与状态设计/8.4_跨组件状态管理Pinia.md)，重点关注组合式 API、路由守卫执行顺序与 Pinia 的 State / Getter / Action 三层。
...
1. 进入 `labs/lab06_前端页面与路由状态/starter`，阅读 `README.md` 与 `package.json`，确认依赖含 `vue`、`pinia`、`vue-router`，脚本含 `dev`、`build`、`preview`。
